...
/// Event published when user verifies their email address
///
/// This event is published when a user clicks the verification link.
...
/// - Update user status (user-service)
...
mod tests {
    ...
    fn test_email_verified_event() {
        ...
        assert_eq!(event.event_type(), "user.email.verified");
    }
    ...
    fn test_into_envelope() {
        ...
        assert_eq!(envelope.event_type, "user.email.verified");

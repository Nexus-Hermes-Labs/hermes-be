...
///
/// This event is published AFTER the user profile is created in user-service.
/// Other services can subscribe to this event to:
/// - Send welcome email (notification-service)
/// - Track user acquisition (analytics-service)
/// - Initialize user preferences (settings-service)

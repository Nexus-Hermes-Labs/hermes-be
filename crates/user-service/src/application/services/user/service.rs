    ...
    UR: UserRepository<Error = RepositoryError>,
{
    ...
    /// Get current user's own profile (includes private privacy settings)
    ...
    pub async fn get_user_profile(
        ...
        //   - user.privacy_settings.show_online_status
        //   - are they friends?
    ...
    /// Update user profile fields (display_name, avatar, banner, bio)

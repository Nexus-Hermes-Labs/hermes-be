...
impl Event {
    pub fn topic(&self) -> String {
        match self {
            Event::UserCreated(_) => "auth.user_profile.created",
            Event::UserDeleted(_) => "auth.user_profile.deleted",
            Event::UserProfileUpdated(_) => "user_profile.profile.updated",
            Event::FriendAdded(_) => "user_profile.friend.added",
            Event::FriendRemoved(_) => "user_profile.friend.removed",
            Event::UserBlocked(_) => "user_profile.blocked",

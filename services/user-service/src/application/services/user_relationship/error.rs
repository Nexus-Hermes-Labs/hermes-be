...
pub enum UserRelationshipApplicationError {
    ...
    #[error("Target user_profile not found: {0}")]
    ...
    #[error("Failed to coordinate user_profile and relationship operations")]
    ...
    fn from(err: RepositoryError) -> Self {
        match err {
            RepositoryError::NotFound(msg) => {
                ...
                else if msg.to_lowercase().contains("user_profile") {
...
impl UserRelationshipApplicationError {
    ...
    /// Get user_profile-friendly error message
    pub fn user_message(&self) -> String {
        match self {
            ...
            Self::FriendshipNotFound => "You are not friends with this user_profile".to_string(),

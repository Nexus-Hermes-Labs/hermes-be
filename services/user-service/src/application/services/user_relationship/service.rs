...
where
    ...
    UR: UserRepository<Error = RepositoryError>,
{
    /// Get friends with user_profile details (enriched)
    ...
    pub async fn get_friends(
        ...
        // 2. Extract target user_profile IDs
    ...
    UR: UserRepository<Error = RepositoryError>,
{
    ...
    /// Check if user_profile has blocked target

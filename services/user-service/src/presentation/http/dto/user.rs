...
use crate::domain::user_profile::valueobject::{
...
/// Public user_profile profile response
///
...
///
/// PATCH /auth/users/me - all fields optional
...
mod tests {
    use super::*;
    use crate::domain::user_profile::UserRole;

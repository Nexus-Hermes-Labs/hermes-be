...
impl AppBuilder {
    ...
    pub fn build(self) -> Result<(Server, GuildServiceServer<GuildServiceGrpc>), BootstrapError> {
        ...
        // ========================================
        let grpc_service =
            GuildServiceGrpc::new(guild_service, member_service, role_service, invite_service);
